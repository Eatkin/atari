...
Overscan:
	...
	; Check if P0Xpos is above 80
	lda P0XPos
	cmp #80
	bcc SkipSubtraction	; Skip the next code if we haven't exceeded bounds

	; If we have exceeded bounds, subtract 40 from P0XPos
	sec
	sbc #40			; subtract 40 because it's our lower bound
	sta P0XPos
